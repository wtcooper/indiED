...
if enable_driving_run:
    st.sidebar.markdown('## Driving Instructions')
    drive_instructions = st.sidebar.text_input("Enter directions (U,D,L,R) separated by a comma", 'U,U,D,D,L,R,L,R')
...
if click_up:
    ...
    session_state.home['lat'] = session_state.home['lat']+step_size/3500.0
    render_map(session_state, indi_ed_lat, indi_ed_lon, image)
...
if click_left:
    ...
    session_state.home['lon'] = session_state.home['lon']-step_size/3500.0
    render_map(session_state, indi_ed_lat, indi_ed_lon, image)
...
if click_reset:
    ...
    session_state.home['lon'] = default_home_lon
    session_state.home['lat'] = default_home_lat
    render_map(session_state, indi_ed_lat, indi_ed_lon, image)

# if click_down_left:
#     st.write('Moving down and to the left!')
#     session_state.home['lat'] = session_state.home['lat']-0.01
#     session_state.home['lon'] = session_state.home['lon']-0.01
